...
export function SongSelector({ songs, onSelect }: SongSelectorProps) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
          <div className="text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 text-transparent bg-clip-text mb-2">
              UmaSong Mixer
            </h1>
        ...
        {filteredSongs.length === 0 && (
            <div className="text-center py-20">
                <p className="text-gray-500 text-lg">No songs found matching "{searchQuery}"</p>
            </div>
        )}
      </div>
    </div>
